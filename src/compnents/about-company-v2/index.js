  ...
  return (
    <div className={inter.className}>
      ...
      <div className={s["container"]}>
        ...
        >
          <Image src={photoAbout1} className={s["image"]} />
          <Image src={photoAbout2} className={s["image"]} />
          <Image src={photoAbout3} className={s["image"]} />
          <Image src={photoAbout4} className={s["image"]} />
        </div>
        <div className={s["about-company"]}>
          <span className={s["reasons"]}>Преимущества</span>
          <div className={s["advantages"]}>
            <a className={s["read-more"]} href="/o-kompanii">
              Читать больше
            </a>
