...
export default function CoHeaderV2() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(
        "https://transline.kz:4444/api/submit-form-connect",
        formData
      );
      router.push("/spasibo");
    } catch (error) {
    ...
    <header className={inter.className}>
      <div className={`${s["container"]} ${scrolled ? s["scrolled"] : ""}`}>
        <div className={s["header-l"]}>
          ...
          <ul
            className={isNav ? [s["menu"], s["active"]].join(" ") : s["menu"]}
          >
            <li>
            ...
            <div className={s["contacts-mobile"]}>
              <div>Контакты</div>
              <a className={s["mail"]} href="mailto:info@transline.kz">
                info@transline.kz
              </a>
              <a
                className={s["phone"]}
        ...
        <div className={s["header-r"]}>
          <div className={s["contacts"]}>
            <span>
              <a href="mailto:info@transline.kz">info@transline.kz</a>
            </span>
            <span onClick={clickOnPhone}>+7 (707) 367-11-04</span>
          </div>
          <button className={s["button-form"]} onClick={openModal}>
            Связаться
          </button>
        </div>
          ...
          {isNav ? (
            ...
            >
              <g id="Frame 1316479">
                <g id="Vector">
                  <path
                    d="M4.00034 18.1421L18.1425 4.00001L19.5567 5.41422L5.41456 19.5564L4.00034 18.1421Z"
                    fill="#161616"
                  />
                  <path
                    d="M19.5563 18.1421L5.41421 4L4 5.41421L18.1421 19.5563L19.5563 18.1421Z"
                    fill="#161616"
                  />
                </g>
              </g>
