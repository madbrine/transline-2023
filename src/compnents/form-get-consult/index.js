  ...
  return (
    <div className={inter.className} ref={props.formRef}>
      ...
      <div className={s["container"]}>
        <div className={s["desc-form"]}>
          <p className={s["desc-h"]}>Получить консультацию</p>
