...
export default function ArendaTehnikiIntroV2(props) {
  ...
  const dataHeadText = {
    "01": "Машиностроение",
    "02": "Строительство и строительная техника",
    "03": "Сельское хозяйство и сельскохозяйственная техника",
    "04": "Автомобильная промышленность",
    "05": "Топливная промышленность и энергетика",
    "06": "Химическая и нефтехимическая промышленность",
    "07": "Нефтегазовая и энергетическая промышленность",
    "08": "Металлургия и металлообработка",
    "09": "Товары народного потребления и логистика",
  };

  const [headText, setHeadText] = useState("Машиностроение");
