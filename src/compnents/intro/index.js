...
function CoIntro() {
  ...
  function storageLoader() {
    sessionStorage.setItem("offerDataFrom", isFrom);
    sessionStorage.setItem("offerDataTo", isTo);
    ...
    sessionStorage.setItem(
      "offerDataChecked",
      isInsuranceChecked ? "да" : "нет"
    );
    console.log(
      `from intro ${sessionStorage.getItem(
        "offerDataTo"
      )} to ${sessionStorage.getItem("offerDataFrom")}`
    );
  }
        ...
        <div className={s["form-container"]}>
          ...
          >
            <div className={s["form-input"]}>
              ...
              <VanishDiv className={s["input-container"]}>
                <input
                  className={s["input-bottom-border"]}
              ...
              <VanishDiv className={s["input-container"]}>
                <a href="/oformit-zayavku" onClick={handleFormSent}>
                  <button onClick={storageLoader} className={inter.className}>
                    Рассчитать
                  </button>
                </a>
              </VanishDiv>
            ...
            <div className={s["insurance-container"]}>
              <label className={s["insurance-box"]}>
                ...
                <div className={inter.className} id={s["text-insurance"]}>
                  {" "}
