...
function KontejnernyePerevozkiIzTajlandaVKazahstan() {
    return (
        <>
            <Head>
                <title>Контейнерные перевозки из Тайланда в Казахстан</title>
                <meta name="description" content="Контейнерные перевозки из Тайланда в Казахстан" />
            ...
            <main>
                ...
                <div className='tpl-margin-h'>
                    <MoBlockHeaderH1 text='Контейнерные перевозки из Тайланда в Казахстан' />
                    <MoNavLinker
                        text2="Контейнерные перевозки из Тайланда в Казахстан"
                        link2="/kontejnernye-perevozki-iz-tajlanda-v-kazahstan"
                    />
                </div>
                <TplPage
...
export default KontejnernyePerevozkiIzTajlandaVKazahstan;