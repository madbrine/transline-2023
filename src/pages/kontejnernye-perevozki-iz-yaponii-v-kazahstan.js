...
function KontejnernyePerevozkiIzYaponiiVKazahstan() {
    return (
        <>
            <Head>
                <title>Контейнерные перевозки из Японии в Казахстан</title>
                <meta name="description" content="Контейнерные перевозки из Японии в Казахстан" />
            ...
            <main>
                ...
                <div className='tpl-margin-h'>
                    <MoBlockHeaderH1 text='Контейнерные перевозки из Японии в Казахстан' />
                    <MoNavLinker
                        text2="Контейнерные перевозки из Японии в Казахстан"
                        link2="/kontejnernye-perevozki-iz-yaponii-v-kazahstan"
                    />
                </div>
                <TplPage
...
export default KontejnernyePerevozkiIzYaponiiVKazahstan;