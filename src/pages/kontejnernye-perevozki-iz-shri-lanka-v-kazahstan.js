...
function KontejnernyePerevozkiIzShriLankaVKazahstan() {
    return (
        <>
            <Head>
                <title>Контейнерные перевозки из Шри Ланка в Казахстан</title>
                <meta name="description" content="Контейнерные перевозки из Шри Ланка в Казахстан" />
            ...
            <main>
                ...
                <div className='tpl-margin-h'>
                    <MoBlockHeaderH1 text='Контейнерные перевозки из Шри Ланка в Казахстан' />
                    <MoNavLinker
                        text2="Контейнерные перевозки из Шри Ланка в Казахстан"
                        link2="/kontejnernye-perevozki-iz-shri-lanka-v-kazahstan"
                    />
                </div>
                <TplPage
...
export default KontejnernyePerevozkiIzShriLankaVKazahstan;