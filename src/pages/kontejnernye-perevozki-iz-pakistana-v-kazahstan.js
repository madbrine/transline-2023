...
function KontejnernyePerevozkiIzPakistanaVKazahstan() {
    return (
        <>
            <Head>
                <title>Контейнерные перевозки из Пакистана в Казахстан</title>
                <meta name="description" content="Контейнерные перевозки из Пакистана в Казахстан" />
            ...
            <main>
                ...
                <div className='tpl-margin-h'>
                    <MoBlockHeaderH1 text='Контейнерные перевозки из Пакистана в Казахстан' />
                    <MoNavLinker
                        text2="Контейнерные перевозки из Пакистана в Казахстан"
                        link2="/kontejnernye-perevozki-iz-pakistana-v-kazahstan"
                    />
                </div>
                <TplPage
...
export default KontejnernyePerevozkiIzPakistanaVKazahstan;