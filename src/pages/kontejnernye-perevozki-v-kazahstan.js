...
function KontejnernyePerevozkiVKazahstan() {
    return (
        <>
            <Head>
                <title>Контейнерные перевозки</title>
                <meta name="description" content="Контейнерные перевозки в Казахстан по разумным ценам." />
            ...
            <main>
                ...
                <div className='tpl-margin-h'>
                    <MoBlockHeaderH1 text='Контейнерные перевозки' />
                    <MoNavLinker
                        text2="Контейнерные перевозки"
                        link2="/kontejnernye-perevozki-v-kazahstan"
                    />
                </div>
                <TplPage
...
export default KontejnernyePerevozkiVKazahstan;