...
function KontejnernyePerevozkiIzIndoneziiVKazahstan() {
    return (
        <>
            <Head>
                <title>Контейнерные перевозки из Индонезии в Казахстан</title>
                <meta name="description" content="Контейнерные перевозки из Индонезии в Казахстан" />
            ...
            <main>
                ...
                <div className='tpl-margin-h'>
                    <MoBlockHeaderH1 text='Контейнерные перевозки из Индонезии в Казахстан' />
                    <MoNavLinker
                        text2="Контейнерные перевозки из Индонезии в Казахстан"
                        link2="/kontejnernye-perevozki-iz-indonezii-v-kazahstan"
                    />
                </div>
                <TplPage
...
export default KontejnernyePerevozkiIzIndoneziiVKazahstan;