...
function GruzoperevozkiAlmatyPetropavlovsk() {
  return (
    <>
      <Head>
        <title>
          Грузоперевозки между Алматой и Петропавловском с Transline
        </title>
        <meta
          name="description"
          content="Transline предлагает профессиональные грузоперевозки по маршруту Алмата - Петропавловск. Надежная и быстрая доставка грузов наших клиентов - наш приоритет."
        />
