...
function KontejnernyePerevozkiIzIndiiVKazahstan() {
    return (
        <>
            <Head>
                <title>Контейнерные перевозки из Индии в Казахстан</title>
                <meta name="description" content="Контейнерные перевозки из Индии в Казахстан" />
            ...
            <main>
                ...
                <div className='tpl-margin-h'>
                    <MoBlockHeaderH1 text='Контейнерные перевозки из Индии в Казахстан' />
                    <MoNavLinker
                        text2="Контейнерные перевозки из Индии в Казахстан"
                        link2="/kontejnernye-perevozki-iz-indii-v-kazahstan"
                    />
                </div>
                <TplPage
...
export default KontejnernyePerevozkiIzIndiiVKazahstan;