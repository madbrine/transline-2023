...
function KontejnernyePerevozkiIzNovojZelandiiVKazahstan() {
    return (
        <>
            <Head>
                <title>Контейнерные перевозки из Новой Зеландии в Казахстан</title>
                <meta name="description" content="Контейнерные перевозки из Новой Зеландии в Казахстан" />
            ...
            <main>
                ...
                <div className='tpl-margin-h'>
                    <MoBlockHeaderH1 text='Контейнерные перевозки из Новой Зеландии в Казахстан' />
                    <MoNavLinker
                        text2="Контейнерные перевозки из Новой Зеландии в Казахстан"
                        link2="/kontejnernye-perevozki-iz-novoj-zelandii-v-kazahstan"
                    />
                </div>
                <TplPage
...
export default KontejnernyePerevozkiIzNovojZelandiiVKazahstan;