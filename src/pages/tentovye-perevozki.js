    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Тентованный кузов автомобиля подойдет для перевозки большинства грузов – как строительных материалов, которые необходимо защитить от ветра или дождя, так и различного промышленного или торгового оборудования." />
            ...
            <main>
                ...
                <div className='tpl-margin-h'>
                    ...
                    <MoNavLinker
                        text2="Тентовые перевозки"
                        link2="/tentovye-perevozki"
                    />
                </div>
                <TplPage
