...
function KontejnernyePerevozkiIzAvstraliiVKazahstan() {
    return (
        <>
            <Head>
                <title>Контейнерные перевозки из Австралии в Казахстан</title>
                <meta name="description" content="Контейнерные перевозки из Австралии в Казахстан" />
            ...
            <main>
                ...
                <div className='tpl-margin-h'>
                    <MoBlockHeaderH1 text='Контейнерные перевозки из Австралии в Казахстан' />
                    <MoNavLinker
                        text2="Контейнерные перевозки из Австралии в Казахстан"
                        link2="/kontejnernye-perevozki-iz-avstralii-v-kazahstan"
                    />
                </div>
                <TplPage
...
export default KontejnernyePerevozkiIzAvstraliiVKazahstan;