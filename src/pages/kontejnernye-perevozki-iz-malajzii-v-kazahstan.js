...
function KontejnernyePerevozkiIzMalajziiVKazahstan() {
    return (
        <>
            <Head>
                <title>Контейнерные перевозки из Малайзии в Казахстан</title>
                <meta name="description" content="Контейнерные перевозки из Малайзии в Казахстан" />
            ...
            <main>
                ...
                <div className='tpl-margin-h'>
                    <MoBlockHeaderH1 text='Контейнерные перевозки из Малайзии в Казахстан' />
                    <MoNavLinker
                        text2="Контейнерные перевозки из Малайзии в Казахстан"
                        link2="/kontejnernye-perevozki-iz-malajzii-v-kazahstan"
                    />
                </div>
                <TplPage
...
export default KontejnernyePerevozkiIzMalajziiVKazahstan;