...
function KontejnernyePerevozkiIzVKazahstan() {
    return (
        <>
            <Head>
                <title>Контейнерные перевозки из Кореи в Казахстан</title>
                <meta name="description" content="Контейнерные перевозки из Кореи в Казахстан" />
            ...
            <main>
                ...
                <div className='tpl-margin-h'>
                    <MoBlockHeaderH1 text='Контейнерные перевозки из Кореи в Казахстан' />
                    <MoNavLinker
                        text2="Контейнерные перевозки из Кореи в Казахстан"
                        link2="/kontejnernye-perevozki-iz-v-kazahstan"
                    />
                </div>
                <TplPage
...
export default KontejnernyePerevozkiIzVKazahstan;