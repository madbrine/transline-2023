...
function KontejnernyePerevozkiIzSingapuraVKazahstan() {
    return (
        <>
            <Head>
                <title>Контейнерные перевозки из Сингапура в Казахстан</title>
                <meta name="description" content="Контейнерные перевозки из Сингапура в Казахстан" />
            ...
            <main>
                ...
                <div className='tpl-margin-h'>
                    <MoBlockHeaderH1 text='Контейнерные перевозки из Сингапура в Казахстан' />
                    <MoNavLinker
                        text2="Контейнерные перевозки из Сингапура в Казахстан"
                        link2="/kontejnernye-perevozki-iz-singapura-v-kazahstan"
                    />
                </div>
                <TplPage
...
export default KontejnernyePerevozkiIzSingapuraVKazahstan;