...
function KontejnernyePerevozkiIzOAEvKazahstan() {
    return (
        <>
            <Head>
                <title>Контейнерные перевозки из О.А.Э. в Казахстан</title>
                <meta name="description" content="Контейнерные перевозки из О.А.Э. в Казахстан" />
            ...
            <main>
                ...
                <div className='tpl-margin-h'>
                    <MoBlockHeaderH1 text='Контейнерные перевозки из О.А.Э. в Казахстан' />
                    <MoNavLinker
                        text2="Контейнерные перевозки из О.А.Э. в Казахстан"
                        link2="/kontejnernye-perevozki-iz-o.a.e.-v-kazahstan"
                    />
                </div>
                <TplPage
...
export default KontejnernyePerevozkiIzOAEvKazahstan;